...
for (const [nm, o] of [["처음", wide], ["병수님 폭 1512", tight], ["오간 뒤", wide2]]) {
  ...
  if (o.왼.r > o.무대.l) fails.push(`① 왼 패널이 무대를 ${o.왼.r - o.무대.l}px 파고든다`);
  if (o.오.l < o.무대.r) fails.push(`① 오른 패널이 무대를 ${o.무대.r - o.오.l}px 파고든다`);
  if (o.왼.l < 0 || o.오.r > o.뷰[0]) fails.push(`① 패널이 화면 밖으로 나갔다(왼 ${o.왼.l} · 오른끝 ${o.오.r}/${o.뷰[0]})`);
  ...
  if (Math.abs(o.위띠.l - o.무대.l) > 1) fails.push(`① 위 띠가 무대와 왼쪽이 ${Math.abs(o.위띠.l - o.무대.l)}px 어긋난다`);
