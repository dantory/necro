...
# ★ 이 선은 「투자 0」이 아니다 — base 12분은 사람 손 없이 과제 넷(army10·offer·gate5·feast)을
#   깨서 **유해 7구 · 배수 ×1.56** 을 번다(첫 획득 4·6·7분 · 실측 2026-08-17 03:03).
#   즉 뒤 절반이 부푼 채 굴러간 값이다. 자세한 것은 js/core.js 의 일지(⑦) 주석.
